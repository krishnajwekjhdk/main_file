...
#
# city_name = "jodhpur"
# data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city_name+"&appid=20a01944eda34a13f4a4dcefff77197").json()
# print(data)
...
com = ttk.Combobox(win,text="Wscube Weather App",values=list_name,font=("Time New Roman",20,"bold"))
